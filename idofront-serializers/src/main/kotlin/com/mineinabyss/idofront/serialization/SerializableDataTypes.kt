...
object SerializableDataTypes {
    ...
    @Serializable
    @JvmInline
    value class Enchantments(val enchantments: List<SerializableEnchantment> = listOf()) : DataType {
    ...
    @Serializable
    @JvmInline
    value class AttributeModifiers(val attributes: List<SerializableAttribute>) : DataType {
